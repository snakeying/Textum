...
`uv run --project .claude/skills/textum/scripts textum split plan check`
...
1) `uv sync --project .claude/skills/textum/scripts`
2) `uv run --project .claude/skills/textum/scripts textum split plan init`
