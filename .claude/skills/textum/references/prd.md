...
读取：`docs/prd-plan-pack.yaml` +（如存在）`docs/PRD.md` | 写入：`docs/PRD.md`（信息不足则不写） | 模板：`.claude/skills/textum/assets/PRD-framework.md` | 可选输入：`FAIL/DECISION` 清单
...
- 严格按 `.claude/skills/textum/assets/PRD-framework.md` 的结构输出所有章节
