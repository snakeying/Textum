...
读取 `docs/PRD.md`，按 `.claude/textum/GLOBAL-CONTEXT-template.md` 模板生成 `docs/GLOBAL-CONTEXT.md`。
...
- GC 禁止 PRD 锚点：`docs/GLOBAL-CONTEXT.md` 中不得出现任何 `PRD#...`（`PRD#<ID>` 仅用于 Story 阶段的最小读取锚点）
